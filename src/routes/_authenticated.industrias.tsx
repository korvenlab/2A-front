    ...
    <AppPage>
      ...
      <div className="rounded-2xl border border-border bg-card p-4 shadow-sm">
        <ListPageSearch
          ...
          ariaLabel="Buscar indústrias"
          hint={
            <>
              A busca considera nome fantasia, responsável, CNPJ e{" "}
              <strong className="font-medium text-foreground">nomes dos produtos</strong> vinculados
              no catálogo. Cadastros e alterações de indústria ficam somente nesta tela.
            </>
          }
          resultText={
            loading
